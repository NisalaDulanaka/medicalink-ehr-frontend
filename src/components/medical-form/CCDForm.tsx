          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Typography>
                ...
                collaborative research efforts, offering you the opportunity to
                be recognized as a co-author in resulting publications. Please
                complete all questions of the patient identification section.
                You may complete the other parts if time permits, or we will
                gather the information on your behalf. Warm regards, Prof
                Dakshitha Wickramasinghe, Professor in Surgery, University
                Surgical Unit.
              </Typography>
            </Grid>
